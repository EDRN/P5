...
def _dmccID(uri):
    ...
    rc = urlparse.urlparse(uri).path.split('/')[-1]
    return rc
...
def main():
    # statements = _readRDF(u'https://edrn.jpl.nasa.gov/cancerdataexpo/rdf-data/diseases/@@rdf')
    statements = _readRDF(u'file:newer-diseases.rdf')
    diseases = {}
    ...
    # statements = _readRDF(u'https://edrn.jpl.nasa.gov/cancerdataexpo/rdf-data/protocols/@@rdf')
