# encoding: utf-8
#
# This is adapted from plone.app.contenttypes.browser.link_redirect_view
# but for eCAS & LabCAS datasets
...
class DatasetRedirectView(BrowserView):

    index = ViewPageTemplateFile('templates/dataset.pt')

    def _url_uses_scheme(self, schemes, url=None):
        url = url or self.context.identifier
