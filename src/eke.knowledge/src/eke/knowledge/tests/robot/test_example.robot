...
#
#  $ bin/test -s eke.knowledge -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src eke.knowledge.testing.EKE_KNOWLEDGE_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/eke/knowledge/tests/robot/test_example.robot
#
